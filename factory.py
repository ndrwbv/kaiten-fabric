...
def echoes_title(summary: str, title: str) -> bool:
    ...
    автоматически и вернуть круг только Додо». В карточке такое ещё читается — заголовок
    рядом, — а в канале человек видит задачу, которую сам же и ставил, и гадает, что
    именно поправили и при чём тут круг.
